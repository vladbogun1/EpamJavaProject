package main.java.ua.nure.bogun.epammed.servlets.nurse;
...
@WebServlet("/nurse")
public class NurseMainServlet extends HttpServlet {
    private static final Logger logger = Logger.getLogger(NurseMainServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session.getAttribute("user") == null) {
            ...
            try {
                ...
                request.getRequestDispatcher("html/nurse/main.jsp").forward(request, response);
            } catch (DBException e) {
